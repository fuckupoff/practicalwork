...
if __name__ == "__main__":
    ...
    print("Current expression:", calc.get_expression())

    calc.append_symbol("=")
    print("After appending '=':", calc.get_expression())

    calc.append_symbol("5")
    print("After appending '5':", calc.get_expression())

    print("Last symbol:", calc.get_last_symbol())

    calc.remove_last_symbol()
    print("After removing last symbol:", calc.get_expression())